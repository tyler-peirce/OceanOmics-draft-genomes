...
# Set OG and DATE variables (replace with actual values)
    ...
    file_list=(
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.busco_sequences.tar.gz
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.busco_sequences.tar.gz.md5
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.full_table.tsv
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/bbtools_err.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/bbtools_out.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/busco.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/hmmsearch_err.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/hmmsearch_out.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/metaeuk_run1_err.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/metaeuk_run1_out.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/metaeuk_run2_err.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs/metaeuk_run2_out.log
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.logs
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.missing_busco_list.tsv
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.short_summary.json
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.short_summary.json.tsv
        $OGdir/assemblies/genome/busco_$TAX/$OG.ilmn.*.v129mh.fna.busco.$TAX.short_summary.txt
        ...
        $OGdir/assemblies/genome/depthsizer/$OG.ilmn.*.v129mh.fna.depthsizer.busco.dupcnv.tsv
        $OGdir/assemblies/genome/depthsizer/$OG.ilmn.*.v129mh.fna.depthsizer.fulltable.tsv
        $OGdir/assemblies/genome/depthsizer/$OG.ilmn.*.v129mh.fna.depthsizer.gensize.tdt
        $OGdir/assemblies/genome/depthsizer/$OG.sorted.bam.busco.fastmp.scdepth
        $OGdir/assemblies/genome/depthsizer
        $OGdir/assemblies/genome/NCBI/adaptor/cleaned_sequences/$OG.ilmn.*.v129mh.fa
        ...
        $OGdir/assemblies/genome/NCBI/$OG.ilmn.*.v129mh.rf.fa
        ...
        $OGdir/assemblies/genome/$OG.ilmn.*.v129mh.fasta.gz
        $OGdir/assemblies/genome/$OG.ilmn.*.v129mh.fna
        $OGdir/assemblies/genome/tiara/log_$OG.ilmn.*.tiara.txt
        $OGdir/assemblies/genome/tiara/mitochondrion_$OG.ilmn.*.rmadapt.fasta
        ...
        $OGdir/assemblies/genome/tiara/plastid_$OG.ilmn.*.rmadapt.fasta
        $OGdir/assemblies/genome/tiara/prokarya_$OG.ilmn.*.rmadapt.fasta
        $OGdir/assemblies/genome/tiara
        $OGdir/assemblies/genome
        $OGdir/assemblies
        $OGdir/fastp/*.fastp.json.tsv
        $OGdir/fastp/*.fastp.json
        $OGdir/fastp/$OG.ilmn.*.fastp.html
        $OGdir/fastp/$OG.ilmn.*.R1.fastq.gz
        $OGdir/fastp/$OG.ilmn.*.R2.fastq.gz
        $OGdir/fastp/fastqc/*_logs/$OG.ilmn.*.R1_fastqc.html
        $OGdir/fastp/fastqc/*_logs/$OG.ilmn.*.R1_fastqc.zip
        $OGdir/fastp/fastqc/*_logs/$OG.ilmn.*.R2_fastqc.html
        $OGdir/fastp/fastqc/*_logs/$OG.ilmn.*.R2_fastqc.zip
        $OGdir/fastp/fastqc/*_logs
        $OGdir/fastp/fastqc
        $OGdir/fastp
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_linear_plot.png
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_log_plot.png
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_model.txt
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_progress.txt
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_summary.txt
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_transformed_linear_plot.png
        $OGdir/kmers/$OG.ilmn.*/$OG.ilmn.*-genomescope_transformed_log_plot.png
        $OGdir/kmers/$OG.ilmn.*
        ...
        $OGdir/kmers/$OG.ilmn.*.meryl.tar.gz
        $OGdir/kmers/$OG.ilmn.*.meryl.hist
        $OGdir/kmers/$OG.ilmn.*.v129mh.merqury.completeness.stats
